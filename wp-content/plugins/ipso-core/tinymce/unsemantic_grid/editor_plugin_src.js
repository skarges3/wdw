...
(function () {
    ...
    tinymce.create('tinymce.plugins.UnsemanticGrid', {
        init: function (editor, url) {
            ...
            function halfCommand(side) {
                return positionCommand(side, 50);
            }
            function positionCommand(side, width) {
...
//# sourceMappingURL=editor_plugin_src.js.map